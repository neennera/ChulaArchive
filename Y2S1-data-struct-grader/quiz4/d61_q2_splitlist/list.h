...
namespace CP
{
  ...
  public:
    ...
    void splitList(list<T> &list1, list<T> &list2)
    {
      ...
      if (k > 0)
      {
        list1.mHeader->prev->next = a;
        a->prev = list1.mHeader->prev;
        list1.mHeader->prev = b->prev;
        b->prev->next = list1.mHeader;
      }

      if (mSize - k > 0)
      {
        list2.mHeader->prev->next = b;
        b->prev = list2.mHeader->prev;
